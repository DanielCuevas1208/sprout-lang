...
// the bytecode virtual machine share the same arithmetic, comparison, index,
// iteration, and builtin behavior. This keeps the two engines consistent and
// lets the standard library live in exactly one place.
//
